        ...
        <div class="relative">
          ...
          >
            ...
            >
              ...
              <!-- Position Line -->
              <div class="absolute top-0 left-1/2 transform -translate-x-1/2 w-0.5 h-full bg-blue-400"></div>
            </div>
            ...
            >
              Frame <%= round(@timeline_position * @frame_count) %> • <%= format_timeline_time(@timeline_position * @video_duration_ms) %>
            </div>
          </div>
