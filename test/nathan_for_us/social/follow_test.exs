defmodule NathanForUs.Social.FollowTest do
  ...
  describe "changeset/2" do
    ...
    test "valid changeset with follower_id and following_id", %{follower: follower, following: following} do
  ...
  describe "database constraints" do
    ...
    test "unique constraint prevents duplicate follows", %{follower: follower, following: following} do
      attrs = %{follower_id: follower.id, following_id: following.id}
